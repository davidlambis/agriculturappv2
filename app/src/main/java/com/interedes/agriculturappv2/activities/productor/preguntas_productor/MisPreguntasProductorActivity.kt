...
import kotlinx.android.synthetic.main.content_preguntas_productor.*

class MisPreguntasProductorActivity : AppCompatActivity(), MisPreguntasProductorView, View.OnClickListener {
