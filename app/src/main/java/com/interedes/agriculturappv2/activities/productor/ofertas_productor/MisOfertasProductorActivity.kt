package com.interedes.agriculturappv2.activities.productor.ofertas_productor
...
import kotlinx.android.synthetic.main.content_ofertas_productor.*

class MisOfertasProductorActivity : AppCompatActivity(), MisOfertasProductorView, View.OnClickListener {
